class BattleUI extends Phaser.Scene {
    ...
    createShopModal() {
        ...
        const legendaryUpgrades = [
            ...
            { name: "Winter Frost", description: "Enraged enemies gain 1.4x original movement speed instead of 2x", cost: 5600, icon: 'winterFrost' },
    ...
    purchaseUpgrade(upgradeName, cost, upgradeIcon) {
        ...
        if (this.gold >= cost) {
            ...
            if (upgradeName === "Winter Frost") {
                ...
                this.scene.get('GameScene').isWinterFrostActive = true;
            }
